...
</details><details><summary>📂 <b>Titkárság - IP Táblázat</b></summary>Az IP címek statikusan vannak kiosztva. A router a fő irodában található routerrel RIP protokollon keresztül kommunikál, valamint a router a szerverszobában lévő fő switch-en keresztül van rákötve a hálózatra. A helységben egy PC is megtalálható, ami az IP Telefonon keresztül van rákötve a hálózatra.Eszközök és IP kiosztás:EszközIP-címAlhálózati maszkAlapértelmezett átjáróNévRouter192.168.10.1255.255.255.0-Router_TitkarRouter (FE)100.100.100.5255.255.255.0--Router (Serial)10.10.10.1255.255.0.0--Switch---Switch_TitkarPC192.168.10.5255.255.255.0192.168.10.1PC_TitkarLaptop192.168.10.3255.255.255.0192.168.10.1Laptop_TitkarNyomtató192.168.10.4255.255.255.0192.168.10.1Nyomtato_TitkarIP Telefon---Telefon_Titkar
</details>
